...
<head>
    ...
    <title>/WebContent/html/login/login.html</title>
    ...
    <div id="wrap">
      ...
      <div class="login">
          <fieldset id="fieldset">
            <legend><span>로 그 인</span></legend>
            <input type="text" class="uid" name="username" placeholder="아이디(필수)"><br><br>
            <input type="password" class="upw" name="password" placeholder="비밀번호(필수)"><br>
            <br>
            <div class="btns">
              <div>
